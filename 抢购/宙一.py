...
authorization_list = {
    '18986680202' : 'MDAwMDAwMDAwMLyEpmmHrq6xftDJZL2os2uNn3vPsX-_mrKNsWWBeHaXsarIapKur6N9urCWsMuvsYKGlZ63fLtqs43HYoB8qNywhMSthoi6snzQ0aqvy6uvgaluow',
    ...
    def createOrder(self,authorization,name,ip):
        ...
        res = requests.post(url,
            headers={
                ...
                'Pragma': 'no-cache',
                'Referer': 'http://h5.zysz.art/detail/1_1_0_0',
                'token': authorization,
