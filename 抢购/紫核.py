...
authorization_list = {
    '18986680202' : 'JSESSIONID=286F83D5B7726B360F823E0E819ACA79; SERVERID=37cbded1be47f215208d737c378c3898|1662451377|1662450517',
    # '17683866129' : 'JSESSIONID=8F337B2D1C9C001B14A69E4C92163FAA; SERVERID=9340da2e5f9eec5f4dfa28105b1c9d75|1662450599|1662450556'
}
...
class qianggou:
    ...
    def run(self,authorization,name):
        ...
        while True:
            if int(time.time() * 1000) > 1662451195000:
                time.sleep(.1)
                break
        ip = self.getIp()
        orderId = None
