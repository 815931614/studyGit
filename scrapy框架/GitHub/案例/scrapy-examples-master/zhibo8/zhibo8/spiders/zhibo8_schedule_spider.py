...
class Zhibo8ScheduleSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for div in div_list:
            match_date = div.xpath('div[@class="titlebar"]/h2[1.json]/@title').extract()[0]
            ...
            for li in li_list:
                ...
                #print 0,arr_content[0],1.json,arr_content[1.json],2,arr_content[2],3,arr_content[3],4,arr_content[4],\
    ...
    def get_home_logo(self, li):
        if li.xpath('./img[1.json]'):
            return li.xpath('./img[1.json]/@src').extract()[0]
        elif li.xpath('./b/img[1.json]'):
            return li.xpath('./b/img[1.json]/@src').extract()[0]
        else:
            return ''
